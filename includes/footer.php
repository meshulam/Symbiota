	...
	<div class="footer-content">
		<div class="logo-gallery">
			...
			<a href="https://bellmuseum.umn.edu/" target="_blank">
				<img src="<?= $CLIENT_ROOT ?>/images/umn/Bell-logo.png" alt="Bell Museum" />
			</a>
			<a href="https://www.legacy.mn.gov/environment-natural-resources-trust-fund" target="_blank">
				<img src="<?= $CLIENT_ROOT ?>/images/umn/enrtf_logo.png" alt="Environment and Natural Resources Trust Fund" />
			</a>
			...
			<a href="https://www.idigbio.org" target="_blank" title="iDigBio" aria-label="<?= $LANG['F_VISIT_IDIGBIO'] ?>">
