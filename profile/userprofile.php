				...
				<fieldset style='padding:15px;width:500px;'>
					...
					<table>
						...
						<tr>
							...
							<td>
								<input id="newpwd" name="newpwd" type="password" minlength="10" autocomplete="new-password"/>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input id="newpwd2" name="newpwd2" type="password" minlength="10" autocomplete="new-password"/>
							</td>
						</tr>
						<tr>
							<td colspan="2">
